  ...
  (function(m) {
    ...
    var A = O.prototype,
        ...
        Q = {
          ...
          setAxisTranslation: function() {
            ...
            if (this.center)
              this.transA = this.isCircular ? (this.endAngleRad - this.startAngleRad) / (this.max - this.min || 1) : this.center[2] / 2 / (this.max - this.min || 1), this.minPixelPadding = this.isXAxis ? this.transA * this.minPointOffset : 0;
          },
          ...
          getPlotBandPath: function(a, b, c) {
            var d = this.center,
                ...
                e = d[2] / 2,
                j = [o(c.outerRadius, "100%"), c.innerRadius, o(c.thickness, 10)],
                l = /%$/,
                h,
                f = this.isCircular;
            this.options.gridLineInterpolation === "polygon" ? d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)) : (a = Math.max(a, this.min), b = Math.min(b, this.max), f || (j[0] = this.translate(a), j[1] = this.translate(b)), j = T(j, function(a) {
    ...
    w(A, "init", function(a, b, c) {
      ...
      if (d) {
        ...
        H(this, Q), this.defaultRadialOptions = (l = e) ? this.defaultRadialXOptions : u(this.defaultYAxisOptions, this.defaultRadialYOptions);
      if (d || g)
        b.inverted = !1, h.chart.zoomType = null;
      a.call(this, b, c);
      if (!j && (d || g)) {
        a = this.options;
        if (!b.panes)
        ...
        if ((this.isCircular = l) && c.max === void 0 && h - b === 2 * Math.PI)
          this.autoConnect = !0;
      }
    });
    ...
    w(z, "getLabelPosition", function(a, b, c, d, g, e, j, l, h) {
      ...
      f.isRadial ? (a = f.getPosition(this.pos, f.center[2] / 2 + o(e.distance, -25)), e.rotation === "auto" ? d.attr({rotation: i}) : k === null && (k = f.chart.renderer.fontMetrics(d.styles.fontSize).b - d.getBBox().height / 2), s === null && (f.isCircular ? (this.label.getBBox().width > f.len * f.tickInterval / (f.max - f.min) && (n = 0), s = i > n && i < 180 - n ? "left" : i > 180 + n && i < 360 - n ? "right" : "center") : s = "center", d.attr({align: s})), a.x += e.x, a.y += k) : a = a.call(this, b, c, d, g, e, j, l, h);
      return a;
    });
    ...
    i.arearange = v(i.area, {
      ...
      getGraphPath: function() {
        ...
        for (var h = l.step,
            d = a.length; d--; )
          e = a[d], !e.isNull && (!a[d + 1] || a[d + 1].isNull) && c.push({
            plotX: e.plotX,
            plotY: e.plotLow
          }), j = {
            plotX: e.plotX,
        ...
        if (e.enabled || this._hasPointLabels) {
          for (c = b; c--; )
            if (f = a[c]) {
              ...
              if (n) {
                if (!j)
                  e.align = k ? "right" : "left";
              } else if (!l)
                e.verticalAlign = k ? "top" : "bottom";
              e.x = e.xHigh;
              e.y = e.yHigh;
            }
          ...
          for (c = b; c--; )
            if (f = a[c]) {
              ...
              if (n) {
                if (!j)
                  e.align = k ? "left" : "right";
              } else if (!l)
                e.verticalAlign = k ? "bottom" : "top";
              e.x = e.xLow;
              e.y = e.yLow;
            }
          g.drawDataLabels && g.drawDataLabels.apply(this, arguments);
      ...
      i.columnrange = v(i.arearange, {
        ...
        translate: function() {
          ...
          t(b.points, function(a) {
            ...
            l ? (e = a.barX + g, a.shapeType = "path", a.shapeArgs = {d: b.polarArc(i + s, i, e, e + a.pointWidth)}) : (k.height = s, k.y = i, a.tooltipPos = j.inverted ? [c.len + c.pos - j.plotLeft - i - s / 2, d.len + d.pos - j.plotTop - k.x - k.width / 2, s] : [d.left - j.plotLeft + k.x + k.width / 2, c.pos - j.plotTop + i + s / 2, s]);
          });
        },
        directTouch: !0,
    ...
    C = {
      type: "gauge",
      pointClass: v(J, {setState: function(a) {
          this.state = a;
        }}),
      angular: !0,
      directTouch: !0,
      ...
      translate: function() {
        ...
        t(this.points, function(d) {
          var g = u(b.dial, d.dial),
              e = B(o(g.radius, 80)) * c[2] / 200,
              j = B(o(g.baseLength, 70)) * e / 100,
    ...
    i.waterfall = v(i.column, {
      ...
      translate: function() {
        ...
        for (c = 0, a = d.length; c < a; c++) {
          ...
          if (g.isSum)
            e.y = b.translate(k[1], 0, 1), e.height = Math.min(b.translate(k[0], 0, 1), b.len) - e.y + this.minPointLengthOffset;
          else if (g.isIntermediateSum)
            e.y = b.translate(k[1], 0, 1), e.height = Math.min(b.translate(f, 0, 1), b.len) - e.y + this.minPointLengthOffset, f = k[1];
          else {
            if (h !== 0)
              e.height = l > 0 ? b.translate(h, 0, 1) - e.y : b.translate(h, 0, 1) - b.translate(h - l, 0, 1);
            h += l;
          }
          ...
          if (e.height <= n)
            e.height = n, this.minPointLengthOffset += n;
      ...
      getAttribs: function() {
        ...
        t(a.points, function(e) {
          if (!e.options.color)
            e.y > 0 ? (e.pointAttr = g, e.color = d) : e.pointAttr = a.pointAttr;
        });
      },
      getGraphPath: function() {
        var a = this.data,
    ...
    i.polygon = v(i.scatter, {
      ...
      getSegmentPath: function(a) {
        return x.prototype.getSegmentPath.call(this, a).concat("z");
      },
      drawGraph: x.prototype.drawGraph,
    ...
    i.bubble = v(i.scatter, {
      ...
      getRadii: function(a, b, c, d) {
        ...
        for (e = 0, g = l.length; e < g; e++)
          j = l[e], f.sizeByAbsoluteValue && j !== null && (j = Math.abs(j - n), b = Math.max(b - n, Math.abs(a - n)), a = 0), j === null ? j = null : j < a ? j = c / 2 - 1 : (j = i > 0 ? (j - a) / i : 0.5, k && j >= 0 && (j = Math.sqrt(j)), j = y.ceil(c + j * (d - c)) / 2), h.push(j);
        this.radii = h;
      },
      animate: function(a) {
      ...
      translate: function() {
        ...
        for (a = b.length; a--; )
          c = b[a], d = g ? g[a] : 0, I(d) && d >= this.minPxSize / 2 ? (c.shapeType = "circle", c.shapeArgs = {
            x: c.plotX,
            y: c.plotY,
            r: d
          }, c.dlBox = {
    ...
    O.prototype.beforePadding = function() {
      ...
      t(this.series, function(b) {
        ...
        if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
          if (a.allowZoomOutside = !0, p.push(b), e)
            t(["minSize", "maxSize"], function(a) {
              var b = g[a],
                  e = /%$/.test(b),
                  b = B(b);
              h[a] = e ? f * b / 100 : b;
      ...
      t(p, function(b) {
        ...
        if (i > 0)
          for (; f--; )
            I(c[f]) && a.dataMin <= c[f] && c[f] <= a.dataMax && (h = b.radii[f], d = Math.min((c[f] - l) * m - h, d), g = Math.max((c[f] - l) * m + h, g));
      });
    ...
    (function() {
      ...
      w(b, "getGraphPath", function(a, b) {
        ...
        if (this.chart.polar) {
          b = b || this.points;
          if (this.options.connectEnds !== !1 && b[0] && b[0].y !== null)
            this.connectEnds = !0, b.splice(b.length, 0, b[0]);
          t(b, function(a) {
      ...
      w(b, "animate", a);
      if (i.column)
        d = i.column.prototype, d.polarArc = function(a, b, c, d) {
          ...
          if (this.chart.polar) {
            ...
            if (i.align === null)
              i.align = a > 20 && a < 160 ? "left" : a > 200 && a < 340 ? "right" : "center";
            if (i.verticalAlign === null)
              i.verticalAlign = a < 45 || a > 315 ? "bottom" : a > 135 && a < 225 ? "top" : "middle";
            b.alignDataLabel.call(this, c, d, i, h, f);
          } else
            a.call(this, c, d, i, h, f);
        });

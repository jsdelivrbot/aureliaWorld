    ...
    Highcharts.Chart.prototype.exportChartLocal = function(exportingOptions, chartOptions) {
      var chart = this,
          ...
          initiateDownload = function() {
            ...
            if (imageType === 'image/svg+xml') {
              ...
              svgurl = svgToDataUrl(svg);
              imageToDataUrl(svgurl, imageType, {}, function(imageURL) {
                try {
      ...
      try {
        ...
        for (i = 0, l = images.length; i < l; ++i) {
          el = images[i];
          imageToDataUrl(el.getAttributeNS('http://www.w3.org/1999/xlink', 'href'), 'image/png', {imageElement: el}, embeddedSuccess, fallbackToExportServer, fallbackToExportServer, fallbackToExportServer);
        }
      } catch (e) {
        fallbackToExportServer();
      }
